...
for j,k in enumerate(ratio_broken_verts): # int array based on topology and ratio
...
for rat in num_broken_verts:
    ...
    for w in range(3,n,1):
        ...
        if w >= 58:
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_aware_agn_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_aware_mig_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_aware_nomig_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_agn_hist_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_awaremig_hist_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}brknComp_layout_awarenomig_hist_bz15')
            plt.clf()
    ...
    #########################
        ...
        with open(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{w}MMtotal_brknComp_data_bz15.txt', 'w') as f:
