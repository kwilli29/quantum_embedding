...
for rat in num_broken_verts:
    ...
    broken_graph = generators.z15_graph(coordinates=True) # only reset every new ratio, not every run
    ...
    #layout = {v:v for v in S_edgelist}
    ...
    for p in range(num_runs):    
        ...
        if p>7:
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{d}brknComp_layout_aware_agn_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{d}brknComp_layout_aware_mig_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{d}brknComp_layout_aware_nomig_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{60}brknComp_layout_agn_hist_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{d}brknComp_layout_awaremig_hist_bz15')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Zephyr/{rat}_{d}brknComp_layout_awarenomig_hist_bz15')
            plt.clf()
