...
# The corresponding graph of Pegasus
...
for rat in num_broken_verts: #run each ratio num_runs times, record data for each ratio
    ...
    for p in range(num_runs):
        ...
        broken_graph = generators.p16_graph() # reset every run
        ...
        if p>7:
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_aware_agn_bp16')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_aware_mig_bp16')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_aware_nomig_bp16')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_agn_hist_bp16')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_awaremig_hist_bp16')
            plt.clf()
            ...
            plt.tight_layout()
            plt.savefig(f'../Desktop/BigCompleteLayoutAware/Pegasus/{rat}_{p}brknComp_layout_awarenomig_hist_bp16')
            plt.clf()
