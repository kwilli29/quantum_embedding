...
class dwave_coordinates:
    """ Architecture agnostic coordinate converter
            ...
            The notation (u, w, k, z) is called the pegasus coordinates index:
                ...
                z : parallel offset
            The notation (u, w, k, j, z) is called the zephyr coordinates index:
                u : qubit orientation (0 = vertical, 1 = horizontal)
...
## KW ##
class zephyr_coordinates(agnostic_coordinates, dnx.zephyr_coordinates):
    """ Augmented chimera_coordinates class """
    def __init__(self, m):
        agnostic_coordinates.__init__(self, 'zephyr')
        dnx.zephyr_coordinates.__init__(self, m)
