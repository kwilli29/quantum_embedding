...
class DiffusionPlacer(DWaveNetworkXTiling):
    """ Diffusion-based migration of a graph layout for Chimera or Zephyr
    """
    def __init__(self, S, Tg, **params):
        ...
        ## KW ##
        # retrieved from old Embera Github code
        ...
        for s_node, s_tile in self.mapping.items():
            ...
            if self.vicinity == 1:
                ...
                for tile in [n,s,w,e]:
                    ## KW ##
                    candidates[s_node] = self.tiles[s_tile].qubits
                    # original: candidates[s_node].update(self.tiles[tile].qubits) [incorrect syntax]
                    ########
                ...
                for tile in neighbor_tiles:
                    ## KW ##
                    if tile in self.tiles: # added if statement
    ...
    def _get_gradient(self, tile):
        ...
        ## KW ##
        # if d_ij == 0.0 or tile.name == None: [name did not initially exist in newest code]
